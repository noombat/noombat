...
/// Broadcast an `Update` activity for the actor's profile to all
/// accepted followers (fire-and-forget). Delegates to the shared
/// [`noombat_federation::update::enqueue_actor_update`] function.
